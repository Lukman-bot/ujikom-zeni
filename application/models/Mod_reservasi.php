...
class Mod_reservasi extends CI_Model
{
    ...
    {
        $query = $this->db->select('reservasi.idreservasi, reservasi.startdate, reservasi.qtykamar, reservasi.lama, reservasi.status,tamu.nik, tamu.nama,tamu.jk,tamu.alamat,tamu.telepon, kamar.namakamar')
            ->from($this->tabel)
